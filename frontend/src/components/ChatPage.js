        ...
        {messages.map((msg, index) => (
          <MessageBubble key={index} isUser={msg.sender === 'user'}>
            ...
            {msg.sender === 'assistant' && (
              <UserInfoContainer>
                <Avatar src="/static/assets/images/A001.png" alt="A001" sx={{ width: 40, height: 40, marginRight: 1 }} />
                <Box>
                  <Typography variant="subtitle2">{assistantName}</Typography>
                  <Typography variant="caption" color="text.secondary">{configStatus}</Typography>
                </Box>
              </UserInfoContainer>
            )}
